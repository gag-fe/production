...
angular.module('newApp').factory('applicationService', ['$resource', '$q', '$rootScope', '$location', 'pluginsService', 'Configuration', function($resource, $q, $rootScope, $location, pluginsService, Configuration) {

    function authorizationService() {
        var routeForUnauthorizedAccess = '/#/404';
        return {
            checkLogin: function() {
                if (!$.cookie('access_token')) {
                    //window.location.href = routeForUnauthorizedAccess;
                }
            },

            permissionCheck: function(id) {
                // 返回一个承诺(promise).
                ...
                if ($.cookie('user_data')) {
                    ...
                    // 检查当前用户是否有权限访问当前路由
                    this.getPermission($.cookie('user_data'), id, deferred);
                } else {
                    // 如果还没权限对象，我们会去服务端获取。

                    $resource(Configuration.API + '/common/findFuncAuthByUser.do?sso_token=' + Configuration.token).get().$promise.then(function(back) {
                        // 当服务器返回之后，我们开始填充权限对象
                        // var back = {};
                        // back.status = 'success';
                        // back.data = {
                        ...
                        //         parentAuthorityId: '12',
                        //         authorityId: '1203',
                        //         authorityName: '特殊指令管理'
                        //     },{
                        //         parentAuthorityId: '12',
                        //         authorityId: '1204',
                        //         authorityName: '设备信息推送'
                        //     },{
                        //         parentAuthorityId: '1',
                        //         authorityId: '13',
                        //         authorityName: '商户配置'
                        //     },{
                        //         parentAuthorityId: '13',
                        //         authorityId: '1301',
                        //         authorityName: '商户渠道关系维护'
                        //     },{
                        //         parentAuthorityId: '1',
                        //         authorityId: '14',
                        //         authorityName: '业务查询'
                        //     },{
                        //         parentAuthorityId: '14',
                        //         authorityId: '1401',
                        //         authorityName: '终端设备文件'
                        //     },{
                        //         parentAuthorityId: '14',
                        //         authorityId: '1402',
                        //         authorityName: '账单信息'
                        ...
                        //         authorityName: '操作记录'
                        //     },{
                        //         parentAuthorityId: '15',
                        //         authorityId: '1501',
                        //         authorityName: '消费行为记录'
                        //     },{
                        //         parentAuthorityId: '15',
                        //         authorityId: '1502',
                        //         authorityName: '系统操作记录'
                        //     }]
                        // }
            ...
            getPermission: function(permissionModel, id, deferred) {
                var ifPermissionPassed = false;

                angular.forEach(JSON.parse($.cookie('user_data')).source, function(data, key) {
                    if (key == id) {
    ...
    applicationService.authorizationService = authorizationService;
    ...
    applicationService.navHover = navHover;
...
}).filter('formatBillType', function() {
    return function(value) {
        ...
        if (typeof convert[value] !== 'function') {
            return "";
        }
