    ...
    .run([
      ...
      function ($templateCache) {
        $templateCache.put('template/treeGrid/treeGrid.html',
          ...
          "       <td><i ng-class=\"row.tree_icon\"\n" +
          "              ng-click=\"row.branch.expanded = !row.branch.expanded\"\n" +
          "              class=\"indented tree-icon\"></i>\n" +
          "           <span class=\"indented tree-label\" ng-click=\"on_user_click(row.branch)\" style=\"margin-left:20px;\">\n" +
          "             {{row.branch[expandingProperty.field] || row.branch[expandingProperty]}} </span>\n" +
          "       </td>\n" +
          "       <td ng-repeat=\"col in colDefinitions\">\n" +
          "         <div ng-if=\"col.cellTemplate\" compile=\"col.cellTemplate\" cell-template-scope=\"col.cellTemplateScope\"></div>\n" +
          "         <div ng-if=\"!col.cellTemplate\"><span>{{row.branch[col.field]}}</span></div>\n" +
          "       </td>\n" +
          "     </tr>\n" +
          "   </tbody>\n" +
          " </table>\n" +
      ...
      function ($timeout,
        ...
        return {
          ...
          link       : function (scope, element, attrs) {
            ...
            attrs.iconExpand = attrs.iconExpand ? attrs.iconExpand : 'glyphicon glyphicon-plus  fa fa-plus';
            ...
            scope.on_user_click = function (branch, self) {
              if (scope.onClick) {
                scope.onClick({
                  branch: branch,
                  self: self
