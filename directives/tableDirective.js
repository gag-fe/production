angular.module('bsTable', []).directive('bsTableControl', function() {
    ...
    $(document)
        ...
        //     var bsTable = getBsTable(evt.target);
        //     if (!bsTable) return;
        //     // bsTable.$el.bootstrapTable('removeByUniqueId', 1);
            
        //     bsTable.$el.bootstrapTable('remove', {field: 'id', values: id});
        ...
        //     var bsTable = getBsTable(evt.target);
        //     if (!bsTable) return;
        //     var rowid=$(this).attr('rowid')-1;
        //     bsTable.$el.bootstrapTable('updateRow', {index:rowid , row: {
        //         "id":"2",
        //         "index": "33",
        //         "name": "update",
